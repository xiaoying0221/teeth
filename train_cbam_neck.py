...
# -*- coding: utf-8 -*-
"""
口腔影像异常区域检测 - YOLOv8s + CBAM(Neck)
exp12: 在 Neck 第一次特征融合后的输出后插入 CBAM，从官方预训练权重开始训练 250 轮
"""
...
MODEL_YAML = Path(r"d:\文档\毕业设计\teeth\yolov8s-cbam-neck.yaml")
...
DEVICE  = "0"
WORKERS = 4
NAME    = "exp12_yolov8s_cbam_neck_250ep"


def main():
    print("=" * 60)
    print("口腔影像异常区域检测 - YOLOv8s + CBAM(Neck)")
