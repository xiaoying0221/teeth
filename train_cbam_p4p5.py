...
# -*- coding: utf-8 -*-
"""
口腔影像异常区域检测 - YOLOv8s + CBAM(P4+P5)
exp11: 仅在 Backbone P4/P5 输出后插入 CBAM，从官方预训练权重开始训练 250 轮
"""
...
MODEL_YAML = Path(r"d:\文档\毕业设计\teeth\yolov8s-cbam-p4p5.yaml")
...
DEVICE  = "0"
WORKERS = 4
NAME    = "exp11_yolov8s_cbam_p4p5_250ep"


def main():
    print("=" * 60)
    print("口腔影像异常区域检测 - YOLOv8s + CBAM(P4+P5)")
